...
/*
            ...
            switch (algorithmType) {
                case NSGAII:
                    algorithm = new NSGAIIBuilder<>(problem, new mutationOperator(), "aaa")
...
--populationSize=250
--maxEvaluations=2000
--selectionOperator=Binary
--tournamentSize=0
--crossoverOperator=NullCrossover
--crossoverProbability=0.0
--mutationOperator=NullMutation
--mutationProbability=0.0

Starting
Started in 2017/10/19 03:15:36
Finished in 2017/10/19 03:15:40*/
