...
public class taxi_Trip_Instance implements Serializable {
    ...
    public String demonstrarCaminhoEmMapa(Mapping map, int v) {
    ...
    public String demonstrarNosEmMapa(Mapping map, int v) {
    ...
    public String eliminarNodesRepetidos(Mapping mape) {
        ...
        percConexao = conectados/(posNodesEmMapa.size()-1);
        return s;
    }
    ...
    public boolean mapearTrip(Mapping mapa, boolean porArestas, double metrosRaioNode, double rand, double distValidacao) {
        ...
        if(porArestas)
        {}//  posNodesEmMapa = mapa.calcIndexNOSQuePassaPelasArestas(lats, lons, metrosRaioNode, false, distValidacao, false);
        else
    ...
    public String getRelatorioConectividade() {
        ...
        return "OK: Comecou com " + nosIniciais + " nós, acabou com " + posNodesEmMapa.size() + " nós! "
