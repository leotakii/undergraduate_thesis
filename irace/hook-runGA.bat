...
java -cp ".;..\..\target\classes;..\..\target\lib;C:\Users\Pc\.m2\repository\org\apache\commons\commons-math3\3.3\commons-math3-3.3.jar" br.ufpr.inf.gres.irace.core.HookRun %FIXED_PARAMS% %CAND_PARAMS% > %LOGS% 2>&1
