...
rem copy NUL %HV%
java -d64 -Xmx5g -cp ".;..\..\target\classes;..\..\target\lib;C:\Users\Pc\.m2\repository\org\apache\commons\commons-math3\3.3\commons-math3-3.3.jar" br.ufpr.inf.gres.irace.core.HookEvaluate %FIXED_PARAMS% > %LOGS% 2>&1
